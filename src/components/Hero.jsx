...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <h1 className="text-white font-poppins font-semibold ss:text-[68px] text-[52px] ss:leading-[100px] leading-[75px] w-full">Payment Method.
      </h1>
    ...
    <div className={`flex-1 flex-col ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[0] w-[70%] h-[70%]  bottom-40 white__gradient"/>
      <div className="absolute z-[0] w-[50%] h-[50%]  bottom-30 blue__gradient"/>
    </div>
